...
public class SearchByLocationActivity extends baseActivity
    ...
    private void jbInit() {
        ...
        //spinnerPais.getBackground().setColorFilter(getResources().getColor(R.color.colorCornFlowerBlue), PorterDuff.Mode.SRC_ATOP);
        //spinnerEstado.getBackground().setColorFilter(getResources().getColor(R.color.colorCornFlowerBlue), PorterDuff.Mode.SRC_ATOP);
        //spinnerCidade.getBackground().setColorFilter(getResources().getColor(R.color.colorCornFlowerBlue), PorterDuff.Mode.SRC_ATOP);

        //cria Controllers
        ControllerLocations controllerPaises = new ControllerLocations(getBaseContext() ,spinnerPais );
